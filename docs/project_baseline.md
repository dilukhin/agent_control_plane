...
> Исторический pre-roadmap baseline от 2026-08-24. Инварианты остаются действующими; формулировки «ещё не выбрано» описывают момент создания. Принятые позднее решения и текущее состояние находятся в [roadmap](roadmap.md), [плане работ](work_plan_ru.md) и связанных R1/ADR документах.
